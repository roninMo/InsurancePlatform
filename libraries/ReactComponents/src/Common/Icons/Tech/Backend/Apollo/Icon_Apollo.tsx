...
export const Icon_ApolloGraphQl = ({ styles }: IconAttributes) => {
  return ( 
    <svg className={styles} xmlns="http://www.w3.org/2000/svg" width="448" height="512" viewBox="0 0 448 512">
      <title>Apollo SVG Icon</title>
